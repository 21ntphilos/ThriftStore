...
exports.verify = exports.GenerateSignature = exports.GenerateOTP = exports.validatePassword = exports.GeneratePassword = exports.GenerateSalt = exports.option = exports.adminSchema = exports.VendorRegisterSchema = exports.loginSchema = exports.UserRegisterSchema = void 0;
...
exports.VendorRegisterSchema = joi_1.default.object().keys({
    ...
    vendorphone: joi_1.default.string().required()
});
...
const validatePassword = (inputPD, userPd) => __awaiter(void 0, void 0, void 0, function* () {
    return bcrypt_1.default.compare(inputPD, userPd);
});
