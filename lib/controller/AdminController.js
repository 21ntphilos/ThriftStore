...
exports.getSingleVendor = exports.getAllProperties = exports.getAllVendors = exports.getAllUsers = exports.AdminRegister = exports.SuperAdminRegister = void 0;
...
const getSingleVendor = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.user;
        ...
        if (admin) {
            const Vendor = (yield Vendor_1.VendorInstance.findOne({
                where: { id: vendorId },
            }));
            return res.status(200).json({
                Vendor,
